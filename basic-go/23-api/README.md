...
<img src="./images/api-web.png" width="500">

api call in thunder client

<img src="./images/api-call-thunder-client.png" width="500">

### Operations output

1. Get list of all courses available.

<img src="./images/getAllCourses.png" width="500">

2. Get only one course

<img src="./images/getOneCourse.png" width="500">
